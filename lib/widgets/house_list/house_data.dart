...
const houseCardExample = [
  HouseCard(
    title: "整租 | 城市经典高迪 2室2厅1卫 10500元月 108平",
    rooms: 2,
    squares: 108,
    community: "城市经典高迪",
    price: 10500,
  ...
  HouseCard(
    title: "首次出租中央空调新风系统，带车位，南北三房，随时看",
    rooms: 3,
    squares: 118,
    community: "九龙仓兰廷",
    price: 9500,
  ...
  HouseCard(
    title: "整租 | 店长!仁恒河滨城(一期)好房出租,居住舒适,干净整洁",
    rooms: 3,
    squares: 152.70,
    community: "仁恒河滨城(一期)",
    price: 19000,
  ...
  HouseCard(
    title: "真房！真价！东外滩 品质豪宅 电梯高层 采光老好 清爽三房",
    rooms: 3,
    squares: 91,
    community: " 保利香槟花园",
    price: 12300,
  ...
  HouseCard(
    title: "复地新都国际，精装修三房，看房随时，拎包入住，近地铁，有车位",
    rooms: 3,
    squares: 130,
    community: "复地新都国际",
    price: 14000,
  ...
  HouseCard(
    title: "整租 | 百兴花园 3室2厅1卫 电梯房 106平 精装修拎",
    rooms: 3,
    squares: 106,
    community: "百兴花园",
    price: 9800,
  ...
  HouseCard(
    title: "西郊独栋别墅可会所办公居家，全新豪装 3个车位 业主急租",
    rooms: 5,
    squares: 445.10,
    community: "尚联西郊创世纪别墅",
    price: 43500,
  ...
  HouseCard(
    title: "（可看实房）丨翠湖御苑南北通两房丨二次装修丨全屋新风地暖",
    rooms: 2,
    squares: 175.00,
    community: " 翠湖天地御苑 ",
    price: 38000,
